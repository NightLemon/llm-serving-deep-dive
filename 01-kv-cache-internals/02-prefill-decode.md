...
**Prefill 总 FLOPS ≈ $2 \times s \times (12d^2 + 4s \times d) \times L$**
...
这远高于 H100 的 **ridge point**（约 260 FLOP/Byte for FP16），因此 Prefill 是 **compute-bound**。
...
312 ├─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ─ ── Compute Ceiling (H100 FP16)
    ...
    │            ╱
    │         ╱    ↑
    │      ╱       │ Ridge Point ≈ 93 (FP16 dense, considering real-world)
    │   ╱          │
    │╱─────────────┼──────────────────────────────
    0   1    10   100   260  1000  10000
